...
Result<void>::Result() : has_error_(false) {}

Result<void>::Result(std::exception_ptr exception_ptr) : exception_ptr_(exception_ptr), has_error_(true) {}

bool Result<void>::HasValue() const noexcept { return !has_error_; }

bool Result<void>::HasError() const noexcept { return has_error_; }

void Result<void>::GetOrThrow() {
